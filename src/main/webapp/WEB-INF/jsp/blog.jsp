		...
		<div id="content" class="site-content">
			<div id="primary" class="content-area column two-thirds">
				...
				<div class="grid bloggrid">
					...
					<h1 class="entry-title"><a href="blog-single.do" rel="bookmark">Somewhere in time</a></h1>
					...
					<div class="entry-summary">
						<p>
							When Mary Lennox was sent to Manor to live with her uncle everybody said she was the most disagreeablelooking child ever seen. It was true, too. She had a little thin face and a little thin body, thin light hair and a sour expression. Her hair was yellow, and her face was yellow because she <a class="more-link" href="blog-single.do">Read more</a>
						</p>
					</div>
					...
					<article>
					<header class="entry-header">
					<h1 class="entry-title"><a href="blog-single.do" rel="bookmark">Thanks for watching</a></h1>
					<div class="entry-meta">
					...
					<article>
					<header class="entry-header">
					<h1 class="entry-title"><a href="blog-single.do" rel="bookmark">Dreaming Away</a></h1>
					<div class="entry-meta">
					...
					<article>
					<header class="entry-header">
					<h1 class="entry-title"><a href="blog-single.do" rel="bookmark">Sunny Days</a></h1>
					<div class="entry-meta">
					...
					<article>
					<header class="entry-header">
					<h1 class="entry-title"><a href="blog-single.do" rel="bookmark">Holiday Travel</a></h1>
					<div class="entry-meta">
					...
					<article>
					<header class="entry-header">
					<h1 class="entry-title"><a href="blog-single.do" rel="bookmark">Driving Summer</a></h1>
					<div class="entry-meta">
			...
			<div id="secondary" class="column third">
				<div id="sidebar-1" class="widget-area" role="complementary">
					...
					<ul>
						<li>
						<a href="blog-single.do">Somewhere in time</a>
						</li>
						<li>
						<a href="blog-single.do">Thanks for watching!</a>
						</li>
						<li>
						<a href="blog-single.do/">Who could have thought?</a>
						</li>
						<li>
						<a href="blog-single.do">Text Alignement</a>
						</li>
						<li>
						<a href="blog-single.do">HTML Tags and Formatting</a>
						</li>
					</ul>
					</aside>
					...
					<ul id="recentcomments">
						<li class="recentcomments"><span>ThemePush</span> on <a href="blog-single.do">Male T-Shirt</a></li>
						<li class="recentcomments"><span>ThemePush</span> on <a href="blog-single.do">Male T-Shirt</a></li>
						<li class="recentcomments"><span><a href="#" rel="external nofollow" class="url">Mr WordPress</a></span> on <a href="blog-single.do">Thanks for watching!</a></li>
						<li class="recentcomments"><span>Maria</span> on <a href="blog-single.do">Gray Blouse</a></li>
						<li class="recentcomments"><span>Maria</span> on <a href="blog-single.do">Retro Dress</a></li>
					</ul>
					</aside>
